...
function provided_session_data(){
    return (array_key_exists('signed-in', $_SESSION) && $_SESSION['signed-in']);
}
...
function getUserByUsername($username){
    ...
    try {
        ...
        die(json_encode([
            'success' => false, 
            'error' => "There was an error fetching rows from table: $e"
        ]));
    }
}
